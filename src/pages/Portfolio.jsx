...
function ProjetoCard({ projeto }) {
  useEffect(() => {
    document.title = "Portfólio | Artha Arquitetura";
  }, []);
  return (
    <Link to={`/portfolio/${projeto.slug}`} className={styles.card}>
      <img
        ...
        alt={`Foto de capa do projeto ${projeto.titulo}`}
      />
      ...
      <div className={styles.hero}>
        <div className={styles.heroText}>
          <h1 className={styles.heroTitle}>
            ...
            <br />A ressignificação do seu modo de viver.
          </h1>
          <p className={styles.heroParagrafo}>
            Projetamos reformas residenciais e comerciais focadas na harmonia,
            organização e no bem-estar. Transformamos espaços para que eles
            contem a sua história.
          </p>
          <div className={styles.heroBotoes}>
            <Link to="/sobre" className={styles.botaoServicos}>
              Nossos serviços
            </Link>
        ...
        <img
          ...
          alt="Foto de um projeto residencial"
        />
      </div>

      <section className={styles.secaoProjetos}>
        <img
          src={decoracaoEstrela}
          className={styles.decorTopoEsquerda}
          alt=""
          aria-hidden="true"
        />
        ...
        <div className={styles.categoriaHeader}>
          <img
            src={logoArtha}
            className={styles.categoriaLogo}
            alt="Logo Artha"
          />
        ...
        <img
          src={decoracaoEstrela}
          className={styles.decorMeioDireita}
          alt=""
          aria-hidden="true"
        />
        ...
        <img
          src={decoracaoEstrela}
          className={styles.decorBaixoEsquerda}
          alt=""
          aria-hidden="true"
        />
        <img
          src={logoArtha}
          className={styles.logoGrandeFinal}
          alt="Logo Artha"
        />
      </section>
