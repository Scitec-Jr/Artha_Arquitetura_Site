        ...
        <>
            ...
            <div className={styles.projects}>
                ...
                <div className={styles.images}>
                    ...
                    <div className={styles.image}>
                        ...
                        <Link className={styles.portfolioText} to="/portfolio">Saiba mais sobre o nosso portfólio</Link>
                    </div>
                </div>
            </div>
            <div className={styles.ourAdvantages}>
                <div className={styles.logoSloganGrid}>
                    ...
                    <div className={styles.meuElemento}><h2 className={styles.Title} id={styles.advantages}>Nossos diferenciais</h2></div>
                    <div className={styles.meuElemento2}><img src={Circulo} className={styles.cImg} alt="decoração circular com estampa" /></div>
                </div>
                <AdvantagesText title = "COMO VOCÊ SONHOU" text="Projetos de arquitetura com propósito e soluções sob medida, que geram valor real para os nossos clientes." img={Img1} w="162px" h="162px" alt="mão segurando diamante"/>
                ...
                <br />
                Executamos seu projeto com qualidade, atento aos prazos e buscando sempre superar as expectativas de entrega.</>} img={Img5} w="114.99px" h="115.12px" alt="selo de positivo"/>
                ...
                <br />
                Gerenciamos todas as etapas da execução, com uma consultoria técnica contínua para garantir total clareza e segurança do início ao fim da obra.</>} img={Img6} w="187px" h="187px" alt="estrelas"/>
            </div>
            <div className={styles.images2}>
                <div className={styles.image2}>
                    <img src={GetinTouch} alt="mão segurando a logo Artha" />
                    <Link className={styles.aboutUs} to="/sobre">Saiba mais sobre quem somos</Link>
                </div>
                <div className={styles.image2}>
                    <img src={Contact} alt="cartão de visitas Artha" />
                    <Link className={styles.contact} to="/contato">Entre em contato</Link>
                </div>
            </div>
            <Footer />
        </>
